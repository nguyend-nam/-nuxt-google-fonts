  ...
  <div class="px-4 pb-4">
    ...
    <Drawer v-model:open="isExpanded">
      ...
      <div class="flex gap-2 mt-2">
        <Select
          v-model:value="filterStore.fontSize"
          class="min-w-[90px] w-max"
        >
      ...
      <Select
        v-model:value="subsetStore.subset"
...
import { Button, Drawer, Select, SelectOption, Textarea, Slider, TypographyTitle, Divider } from "ant-design-vue";
